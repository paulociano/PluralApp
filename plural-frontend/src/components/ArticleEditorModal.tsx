...
export default function ArticleEditorModal({ isOpen, onClose, onSuccess, articleToEdit }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4">
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-xl w-full max-w-3xl h-[95vh] flex flex-col">
        {/* CABEÇALHO (Fixo) */}
        <div className="flex justify-between items-center p-6 border-b shrink-0">
          <h2 className="font-lora text-2xl font-bold text-[#2D4F5A]">
            {articleToEdit ? 'Editar Artigo' : 'Novo Artigo'}
          </h2>
