    ...
    <div className="bg-white min-h-screen py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <article>
          ...
          {/* --- CORREÇÃO AQUI --- */}
          <div
            // A classe 'prose' do plugin de tipografia estiliza o HTML
            className="prose font-manrope text-lg text-justify text-gray-800 leading-relaxed max-w-none"
            // Esta prop renderiza a string 'content' como HTML
