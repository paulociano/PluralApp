...
function ArticlePageContent() {
  ...
  return (
    // 1. O 'div' principal agora tem as classes de fundo da página de login
    <div className="min-h-screen bg-[#2D4F5A] bg-center py-12">
      {/* 2. O 'div' do conteúdo tem um fundo branco, sombra e está centralizado */}
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 bg-white shadow-lg rounded-lg">
        <div className="py-8">
            <div className="mb-8">
            ...
            <article>
              ...
              <div
                className="prose font-manrope text-lg text-gray-800 leading-relaxed max-w-none whitespace-pre-wrap"
              >
                {article.content}
              </div>
            </article>
